...
import 'application/interceptor/interceptor_bloc.dart' as _i10;
...
import 'infrastructure/survey/check_latest_survey_facade.dart' as _i3;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i3.CheckLatestSurveyFacade>(
      () => _i3.CheckLatestSurveyFacade());
  ...
  gh.factory<_i10.InterceptorBloc>(
      () => _i10.InterceptorBloc(get<_i7.IStorage>()));
  gh.factory<_i11.OnBoardingBloc>(
      () => _i11.OnBoardingBloc(get<_i7.IStorage>()));
  ...
  await gh.lazySingletonAsync<_i14.Dio>(
      ...
      registerFor: {_prod},
      preResolve: true);
  gh.factory<_i5.Env>(() => _i5.EnvDev(get<_i7.IStorage>()),
      registerFor: {_dev});
