...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i3.AppPreferencesBloc>(() => _i3.AppPreferencesBloc());
  ...
  gh.lazySingleton<_i7.IDatabase>(() => _i8.AppDatabase());
  gh.lazySingleton<_i9.IStorage>(() => _i10.Storage(get<_i11.HiveInterface>()));
  gh.factory<_i12.OnBoardingBloc>(
      () => _i12.OnBoardingBloc(get<_i9.IStorage>()));
  gh.lazySingleton<_i13.OneSignal>(() => registerModule.oneSignal);
  gh.factory<_i14.SimpleBlocObserver>(() => _i14.SimpleBlocObserver());
  await gh.lazySingletonAsync<_i15.Dio>(
      () => registerModule.dioDev(get<_i9.IStorage>()),
      registerFor: {_dev},
      preResolve: true);
  await gh.lazySingletonAsync<_i15.Dio>(
      () => registerModule.dio(get<_i9.IStorage>()),
      registerFor: {_prod},
      preResolve: true);
  gh.factory<_i5.Env>(() => _i5.EnvDev(get<_i9.IStorage>()),
      registerFor: {_dev});
